...
var _nav = _interopRequireDefault(__webpack_require__(5));

var _news = _interopRequireDefault(__webpack_require__(6));

var _introSlider = _interopRequireDefault(__webpack_require__(8));
...
__webpack_require__(10); // utils
//----------------------------------------------


__webpack_require__(21); // components
//----------------------------------------------
...
var Nav = {
  ...
  clickNavBtn: function clickNavBtn() {
    var _this = this;
  ...
  resizeHandle: function resizeHandle() {
    ...
    this.$window.resize(function () {
      if (window.matchMedia("(min-width: ".concat(_this2.mdVw, "px)")).matches) {
        _this2.hideNav();
      }
    });
  }
...
var config = {
  ...
  pagination: {
    ...
    renderBullet: function renderBullet(index, className) {
      return "<span class=".concat(className, ">").concat(_data.svgBullet, "</span>");
    }
  },
  breakpoints: {
...
var News = {
  ...
  initSlider: function initSlider() {
    ...
    $('.js-news-slider').each(function init() {
      ...
      swiper.on('init', function () {}); // init Swiper
...
exports.svgBullet = void 0;
var svgBullet = "\n    <svg height=\"20\" width=\"20\" viewBox=\"0 0 20 20\" class=\"svg\">\n        <circle class=\"svg__circle\" cx=\"10\" cy=\"10\" r=\"7\"\n            stroke=\"currentColor\" stroke-width=\"4\" fill-opacity=\"0\" opacity=\"0.4\">\n        </circle>\n        <circle class=\"svg__circle-anim\" cx=\"10\" cy=\"10\" r=\"7\"\n            stroke=\"currentColor\" stroke-width=\"4\" fill-opacity=\"0\" style=\"stroke-dashoffset: 45; stroke-dasharray:45\">\n        </circle>\n    </svg>";
exports.svgBullet = svgBullet;
...
var Intro = {
  ...
  initFraction: function initFraction(swiper, totalSlides) {
    var $el = swiper.$el;
    var $currFraction = $el.find('.js-fr-current');
    var $totalFraction = $el.find('.js-fr-total');
    $currFraction.text('01');
    $totalFraction.text(totalSlides > 9 ? totalSlides : "0".concat(totalSlides));
  },
  slideChange: function slideChange(swiper) {
    var $el = swiper.$el,
        realIndex = swiper.realIndex;
    var $currFraction = $el.find('.js-fr-current');
    var idxText = ++realIndex > 9 ? realIndex : "0".concat(realIndex);
...
var _swiper = _interopRequireDefault(__webpack_require__(11));
...
var _modernizr = _interopRequireDefault(__webpack_require__(23));
...
_modernizr.default.addTest('ipad', function () {
  return !!navigator.userAgent.match(/iPad/i);
});

_modernizr.default.addTest('iphone', function () {
  return !!navigator.userAgent.match(/iPhone/i);
});

_modernizr.default.addTest('ipod', function () {
  return !!navigator.userAgent.match(/iPod/i);
});

_modernizr.default.addTest('appleios', function () {
  return _modernizr.default.ipad || _modernizr.default.ipod || _modernizr.default.iphone;
});

_modernizr.default.addTest('ie', isIe);

_modernizr.default.addTest('ie-10', isIe10);

_modernizr.default.addTest('ie-11', isIe11);

_modernizr.default.addTest('edge', isEdge);

_modernizr.default.addTest('windows', isWin);
...
var container = document.querySelector('.canvas-404');
...
var init = function init() {
  ...
  ribbon = new THREE.Mesh(new THREE.PlaneGeometry(1, 1, 128, 128), new THREE.ShaderMaterial({
    uniforms: {
      time: {
        value: 1.0
      }
